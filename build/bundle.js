var app = (function () {
    ...
    /* src\HowTo.svelte generated by Svelte v3.46.4 */
    ...
    /* src\ProgressBar.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0 = element("div");
    			span = element("span");
    			t0 = text(/*barWidth*/ ctx[0]);
    			t1 = text("%");
    			attr(span, "class", "sr-only");
    			attr(div0, "class", "progress-bar svelte-kv3syo");
    			set_style(div0, "width", /*barWidth*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-kv3syo");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*barWidth*/ 1) set_data(t0, /*barWidth*/ ctx[0]);
    ...
    class ProgressBar extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { barWidth: 0 });
    	}
    }

    /* src\Timer.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	progressbar = new ProgressBar({ props: { barWidth: /*barWidth*/ ctx[2] } });
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*barWidth*/ 4) progressbar_changes.barWidth = /*barWidth*/ ctx[2];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*secondsLeft*/ 1) {
    			$$invalidate(2, barWidth = (totalSeconds - secondsLeft) / totalSeconds * 100);
    		}
    	};

    	return [secondsLeft, isRunning, barWidth, startTimer];
    }
    ...
    <a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound Source</a>`;
    			...
    			if (!src_url_equal(audio_1.src, audio_1_src_value = "sound.mp3")) attr(audio_1, "src", audio_1_src_value);
    		},
    		m(target, anchor) {
